...
const generateSampleEmails = () => {
  const baseEmails = [
    {
      ...
      body: "Check out what happened in your repositories today. There were 15 new issues, 3 pull requests, and 8 comments.",
    ...
    },
    {
      ...
      body: "We are excited to announce our latest feature that uses AI to summarize long email threads. Try it out now and let us know what you think!",
      date: new Date(
    ...
    },
    {
      ...
      body: "Expand your network with these professionals who have requested to connect with you. View their profiles and decide whether to accept.",
      date: new Date(
    ...
    },
    {
      ...
      subject: "Your monthly AWS bill is now available",
      body: "Your AWS bill for the month of September is now available for viewing and payment. The total amount due is $42.50.",
      date: new Date(
    ...
    },
    {
      ...
      subject: "Design review for MailFlare Dashboard",
      body: "Hi team, please review the attached design mockups for the new dashboard analytics page. We need your feedback by end of day tomorrow. Thanks!",
      date: new Date(
  ...
  const additionalTemplates = [
    {
      ...
      body: "See what you missed this week on Twitter. Your tweets got 1,200 impressions.",
    },
    {
      sender: "Slack",
      subject: "New messages in your workspace",
      body: "You have unread messages in the #general and #design channels.",
    },
    {
      sender: "Stripe",
      subject: "Receipt for your recent payment",
      body: "Thank you for your payment to Notion. Here is your receipt.",
    },
    {
      sender: "Dropbox",
      subject: "Your storage is almost full",
      body: "Your Dropbox storage is 85% full. Upgrade now to get more space.",
    },
    {
      sender: "Medium",
      subject: "Recommended reading for you",
      body: "Based on your interests in AI and product design, we think you might like these new articles.",
    },
    {
      sender: "Figma",
      subject: "Someone commented on your design",
      body: 'Jane Doe left a comment on your "Mobile App Login Flow" design. Click here to view it.',
    },
    {
      sender: "Notion",
      subject: "Your workspace summary",
      body: "Here is what happened in your workspace this week. 10 new pages were created.",
    },
  ];
  ...
  for (let i = 6; i <= 25; i++) {
    ...
    const body = `${template.body} (Ref: ${Math.random()
      .toString(36)
      .substring(7)})`;
    allEmails.push({
      id: i.toString(),
      ...
      aiReplies: [
        `Thanks for the update! Could you share more details on ${
          template.sender === "Design Team" ? "the mockups" : "this"
        }?`,
